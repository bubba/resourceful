...
reduced any further (in its normal form) and is not a value.
...
\begin{proof}
  ...
  \item[\rm\textsc{Let}] There is only way a let expression can
    reduce, and that is by ${\letin{x = e'}{e} \leadsto e [e' / x]}$. The
    premises are
    \begin{align*}
  ...
  \item[\rm\textsc{Conc}] We have the proof and premises
    ...
    \begin{align*}
      ...
      \centerdot , v : \tau_1 \vdash w : \IO_{\rho_2} \tau_2 && \text{by
                                                   lemma~\ref{lem:weaken}} \\
