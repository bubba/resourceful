...
properties.  We prove these properties in chapter~\ref{chapter:properties}, in
which we eventually build up and present a proof of its soundness. This proof,
and the others that accompany it, are then formalised within the dependently
typed language and proof assistant Agda. The technique and design used to do so
are discussed in chapter~\ref{chapter:agda}.
