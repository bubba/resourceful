...
jewels of functional language research.
...
type system. Our monadic and resourceful extensions to the Hindley-Damas-Milner
are compatible and we have shown this by proving soundness.
% fit nicely into exiting monadic languages
Along the way we have also created a foundation for mechanising the proof of
soundness for Hindley-Damas-Milner within Agda.
